  ...
  return (
    <div className="bg-white border-x-gray-800 flex-co lg:flex-row justify-between items-center">
        ...
        <p className='font-extrabold font-sans text-2xl '>Free</p>
            ...
            <p className='flex'>Sync Unlimited devices</p>
            <p className='flex'>10 GB monthly uploads</p>
            <p className='flex'>200 MB max not size</p>
            <p className='flex'>Customize Home dashbord and access extra</p>
            <p className='flex'>Connect primary Google caleander account</p>
            <p className='flex'>add due, dates, remaindes,and notifications to yout tasks.</p>
